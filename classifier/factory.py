...
def get_classifier(ebd_dim, args):
    ...
    elif args.classifier == 'rn':
        model = RN(ebd_dim, args)
    elif args.classifier == 'mn':
        model = MN(ebd_dim, args)
    elif args.classifier == 'contrastnet':
        model = ContrastNet(ebd_dim, args)
